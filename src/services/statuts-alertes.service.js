...
const tableName = "statuts_alertes";
const columns = [
  {
    "name": "id_statut_alerte",
    "propertyName": "idStatutAlerte"
  },
  {
    "name": "nom_statut",
...
const primaryKey = "id_statut_alerte";
const primaryKeyProperty = "idStatutAlerte";
