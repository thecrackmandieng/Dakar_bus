...
export class ParametresPage {
  readonly modules = [
    ...
    { name: 'Utilisateurs', route: '/utilisateurs', description: 'Comptes administrateurs et conducteurs' },
    { name: 'Alertes', route: '/alertes', description: 'Consulter et gérer les alertes du réseau' },
