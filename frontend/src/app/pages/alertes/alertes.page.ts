...
export class AlertesPage implements OnInit {
  ...
  successOpen = false;
  successMessage = '';
  pendingDelete: Alertes | null = null;
  ...
  async save(): Promise<void> {
    ...
    try {
      if (this.editingId === null) {
        await this.service.create(this.form as Partial<Alertes>);
        this.successMessage = 'Element cree avec succes.';
      } else {
        await this.service.update(this.editingId, this.form as Partial<Alertes>);
